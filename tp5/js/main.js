...
window.onload = function () {
    app = new Vue({
        ...
        data: {
            ...
            // liste des villes saisies, initialiser avec Alger
            cityList: [{
                name: 'Alger'
            }],
        ...
        methods: {
            ...
            meteo: function (_city) {
                ...
                fetch('https://api.openweathermap.org/data/2.5/weather?q=' + _city.name + '&units=metric&lang=fr&apikey=e331f6f3078c3e058234e05ce506a7e9')
